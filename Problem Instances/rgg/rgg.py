...
nbOfInstances = 25      #number of instances
n = 100                  #number of vertices
rad = 0.5               #edges will be added to vertices within the radius of eachother
...
for i in range(nbOfInstances):
    ...
    if min_tree_edges == len(ug.get_vertices()) - 1:
        ...
        #Write to file
        ofile = "instances/rgg-" + str(n) + "-" + str(len(ug.get_edges())) + "-" + str(i) + ".txt"
